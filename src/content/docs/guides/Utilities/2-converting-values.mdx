...
write_line("Binary value: " + binary_string);
```
...
WriteLine("Binary value: " + binaryString);
```
...
uint decimalValue = 10;
string binaryString = DecToBin(decimalValue);
SplashKit.WriteLine("Binary value: " + binaryString);
```
...
write_line("Decimal value: " + to_string(decimal_value));
```
...
string binaryString = "1010";
uint decimalValue = BinToDec(binaryString);
SplashKit.WriteLine("Decimal value: " + decimalValue);
```
...
write_line("Decimal value:", decimal_value)
```
...
write_line("Hexadecimal value: " + hex_string);
```
...
WriteLine("Hexadecimal value: " + hexString);
```
...
string binaryString = "10100011";
string hexString = BinToHex(binaryString);
SplashKit.WriteLine("Hexadecimal value: " + hexString);
```
...
write_line("Octal value: " + octal_string);
```
...
WriteLine("Octal value: " + octalString);
```
...
uint decimalValue = 10;
string octalString = DecToOct(decimalValue);
SplashKit.WriteLine("Octal value: " + octalString);
```
...
:::note
This function relies on the `hex_to_bin` function defined above.
:::
...
:::note
This function relies on the `oct_to_bin` function defined above.
:::
